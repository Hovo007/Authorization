...
const validation = (body , isLogin = false) => {
    if (!isLogin) {
        ...
        } else if (body.name.length <= 4 || body.name.length > 25) {
            return {
                isValid: false,
                message: "Your name must be min 5 elements or max 25 elements"
            }
        }
        if (!body.surname) {
            return {
            ...
            return {
                isValid: false,
                message: "Your surname must be min 5 elements or max 25 elements"
            }
        }
        if (!body.phone) {
            return {
